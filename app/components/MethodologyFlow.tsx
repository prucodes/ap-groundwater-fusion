...
const nodes = [
  ...
  {
    title: "Fusion Engine",
    desc: "Fuses APWRIMS sensor history with satellite rainfall to estimate the level (metres) + a recharge-vs-decline signal per mandal.",
    icon: <IconFlow />,
    bg: "linear-gradient(145deg, #3f86d6, #2a5f9e)",
  },
  {
    title: "Confidence Score",
    desc: "Agreement + data freshness → confidence label and status bucket.",
    icon: <IconTarget />,
    bg: "linear-gradient(145deg, #5e9b6b, #467553)",
  },
  {
    title: "AWARE / APWRIMS Action Output",
    desc: "Prototype action language with explicit non-official caveats.",
    icon: <IconShield />,
